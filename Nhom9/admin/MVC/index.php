...
<aside class="app-sidebar">
    <div class="app-sidebar__user">
        <img class="app-sidebar__user-avatar" src="https://litiflorist.com/assets/img/liti-logo.png" width="50px" alt="User Image">
        <div>
            <?php
            // Check if the 'login' key is set in the $_SESSION array
            if (isset($_SESSION['login']) && isset($_SESSION['login']['name'])) {
                ?>
                <p class="app-sidebar__user-name">
                    <b>Xin Chào <?= $_SESSION['login']['name'] ?></b> Liti Florist
                </p>
            <?php
            } else {
                // Handle the case when 'login' key or 'name' key is not set
                ?>
                <p class="app-sidebar__user-name">
                    <b>Xin Chào</b> Liti Florist
                </p>
            <?php
            }
            ?>
    ...
    <ul class="app-menu">
        ...
        <li><a href="../?act=home" class="app-menu__item haha"><i class='app-menu__icon bx bx-cart-alt'></i>
            ...
            <li><a class="app-menu__item" href="?act=product&xuli=join"><i
                    class='app-menu__icon bx bx-purchase-tag-alt'></i><span class="app-menu__label">Quản lý shop hoa</span></a>
            </li>
