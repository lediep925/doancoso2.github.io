        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="https://img.gotit.vn/compress/brand/1602215626_E8XZh.png" alt="IMG">
                </div>
                <!--=====TIÊU ĐỀ======-->
                <form class="login100-form validate-form" method="POST" action="?act=login&xuli=join">
                    
                    <span class="login100-form-title">
                        <a href="?act=home"><img class="login-img" src="https://litiflorist.com/assets/img/liti-logo.png" alt=""></a>
                        <b>ĐĂNG NHẬP</b>
                    </span>
                    ...
                    <!--<div class="text-center p-t-70 txt2">
                        Liti Florist <i class="far fa-copyright" aria-hidden="true"></i>
